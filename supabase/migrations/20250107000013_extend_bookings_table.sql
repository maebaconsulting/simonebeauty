-- Migration: Extend appointment_bookings table
-- Feature: 007-contractor-interface
-- Description: Ajout des colonnes nécessaires pour le suivi des tips et statuts prestataire

-- Add tip-related columns
