...
serve(async (req) => {
  ...
  try {
    ...
    // Create contractor entry with market assignment
    ...
    const { data: contractor, error: contractorError } = await supabaseClient
      ...
      .insert({
        id: authUser.user.id,
        market_id: application.market_id, // Transfer market from application
      ...
      if (RESEND_API_KEY) {
        const emailResponse = await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            ...
            subject: '🎉 Bienvenue chez Simone Paris - Votre candidature est approuvée !',
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h1 style="color: #16a34a;">Félicitations ${application.first_name} !</h1>

                <p>Nous sommes ravis de vous informer que votre candidature a été acceptée. Bienvenue dans l'équipe Simone Paris ! 🎉</p>
                ...
                <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; margin: 24px 0;">
                  <p style="margin: 0; color: #92400e;">⚠️ <strong>Important :</strong> Vous devrez changer ce mot de passe lors de votre première connexion.</p>
                </div>

                <h2 style="color: #1e40af;">Prochaines étapes</h2>
                <ol style="line-height: 1.8;">
                  <li>Connectez-vous à votre espace prestataire : <a href="${Deno.env.get('NEXT_PUBLIC_SITE_URL') || 'http://localhost:3000'}/contractor/login" style="color: #2563eb;">Se connecter</a></li>
                  <li>Complétez votre processus d'onboarding (3 étapes) :
                    <ul>
                      <li>Configurez vos horaires de disponibilité</li>
                      <li>Connectez votre compte Stripe pour recevoir vos paiements</li>
                      <li>Finalisez votre profil public</li>
                    </ul>
                  </li>
                  <li>Commencez à recevoir des demandes de clients</li>
                </ol>

                <div style="background-color: #eff6ff; border-left: 4px solid #2563eb; padding: 16px; margin: 24px 0;">
                  <p style="margin: 0;"><strong>Votre lien de réservation personnalisé :</strong><br>
